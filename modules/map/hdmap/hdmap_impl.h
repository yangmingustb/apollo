...
public:
     ...
     */
    int
    LoadMapFromFile(const std::string& map_filename);
     ...
     */
    int
    LoadMapFromProto(const Map& map_proto);
    ...
    GetParkingSpaceById(const Id& id) const;
    PNCJunctionInfoConstPtr
    GetPNCJunctionById(const Id& id) const;
    RSUInfoConstPtr
    GetRSUById(const Id& id) const;
     ...
     */
    int
    GetLanes(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetJunctions(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetCrosswalks(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetSignals(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetStopSigns(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetYieldSigns(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetClearAreas(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetSpeedBumps(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetRoads(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetParkingSpaces(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetPNCJunctions(const apollo::common::PointENU& point, double distance,
     ...
     */
    int
    GetNearestLane(const apollo::common::PointENU& point,
     ...
     */
    int
    GetRoi(const apollo::common::PointENU& point, double radius,
     ...
     */
    int
    GetLocalMap(const apollo::common::PointENU& point,
     ...
     */
    int
    GetForwardNearestRSUs(const apollo::common::PointENU& point,
...
private:
    int
    GetLanes(const apollo::common::math::Vec2d& point, double distance,
            std::vector<LaneInfoConstPtr>* lanes) const;
    int
    GetJunctions(const apollo::common::math::Vec2d& point, double distance,
            std::vector<JunctionInfoConstPtr>* junctions) const;
    int
    GetCrosswalks(const apollo::common::math::Vec2d& point, double distance,
            std::vector<CrosswalkInfoConstPtr>* crosswalks) const;
    int
    GetSignals(const apollo::common::math::Vec2d& point, double distance,
            std::vector<SignalInfoConstPtr>* signals) const;
    int
    GetStopSigns(const apollo::common::math::Vec2d& point, double distance,
            std::vector<StopSignInfoConstPtr>* stop_signs) const;
    int
    GetYieldSigns(const apollo::common::math::Vec2d& point, double distance,
            std::vector<YieldSignInfoConstPtr>* yield_signs) const;
    int
    GetClearAreas(const apollo::common::math::Vec2d& point, double distance,
            std::vector<ClearAreaInfoConstPtr>* clear_areas) const;
    int
    GetSpeedBumps(const apollo::common::math::Vec2d& point, double distance,
            std::vector<SpeedBumpInfoConstPtr>* speed_bumps) const;
    int
    GetParkingSpaces(const apollo::common::math::Vec2d& point, double distance,
            std::vector<ParkingSpaceInfoConstPtr>* parking_spaces) const;
    int
    GetPNCJunctions(const apollo::common::math::Vec2d& point, double distance,
            std::vector<PNCJunctionInfoConstPtr>* pnc_junctions) const;
    int
    GetNearestLane(const apollo::common::math::Vec2d& point,
            LaneInfoConstPtr* nearest_lane, double* nearest_s,
            double* nearest_l) const;
    int
    GetNearestLaneWithHeading(const apollo::common::math::Vec2d& point,
            const double distance, const double central_heading,
            const double max_heading_difference, LaneInfoConstPtr* nearest_lane,
            double* nearest_s, double* nearest_l) const;
    int
    GetLanesWithHeading(const apollo::common::math::Vec2d& point,
            const double distance, const double central_heading,
            const double max_heading_difference,
            std::vector<LaneInfoConstPtr>* lanes) const;
    int
    GetRoads(const apollo::common::math::Vec2d& point, double distance,
            std::vector<RoadInfoConstPtr>* roads) const;
    ...
    template <class Table, class BoxTable, class KDTree>
    static void
    BuildPolygonKDTree(const Table& table,
            const apollo::common::math::AABoxKDTreeParams& params,
            BoxTable* const box_table, std::unique_ptr<KDTree>* const kdtree);
    ...
    static int
    SearchObjects(const apollo::common::math::Vec2d& center,
