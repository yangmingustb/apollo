...
DEFINE_double(
        minimum_point_spacing, 5.0, "The minimum distance for input points.");
...
public:
            ...
            std::vector<common::PathPoint>* ptr_smooth_points)
    {
        ...
        *ptr_smooth_points = spiral_smoother.Interpolate(opt_theta, opt_kappa,
                opt_dkappa, opt_s, opt_x, opt_y, config.resolution());
