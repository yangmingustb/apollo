...
private:
     ...
     * @brief
     *
     * @param init_state path start point, l condition
     * @param end_state path end point, l condition
    ...
    FrenetFramePath ToPiecewiseJerkPath(const std::vector<double>& l,
            const std::vector<double>& dl, const std::vector<double>& ddl,
            const double delta_s, const double start_s) const;
