...
bool
Smoother::IsCloseStop(
        const common::VehicleState& vehicle_state, const MainStop& main_stop)
{
...
Smoother::Smooth(const FrameHistory* frame_history, const Frame* current_frame,
