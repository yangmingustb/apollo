...
DEFINE_string(
        test_previous_planning_file, "", "The previous planning test file");
...
void PlanningTestBase::SetUp()
{
    ...
    ACHECK(cyber::common::GetProtoFromFile(
            FLAGS_test_planning_config_file, &config_))
...
void PlanningTestBase::TrimPlanning(
        ADCTrajectory* origin, bool no_trajectory_point)
{
